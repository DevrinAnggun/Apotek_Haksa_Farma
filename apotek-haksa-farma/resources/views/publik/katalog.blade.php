                    ...
                    <div class="mt-auto pt-3 border-t border-gray-50 flex items-center justify-between">
                        ...
                        <div class="flex flex-col items-end gap-2">
                            ...
                            <div class="flex items-center gap-1.5">
                                ...
                                @endif
                                <a href="https://wa.me/6285385984906?text=Halo%20Apotek%20Haksa%20Farma%2C%20saya%20ingin%20tanya%20obat%3A%20{{ urlencode($obat->nama_obat) }}" 
                                   target="_blank" 
                                   class="bg-green-500 hover:bg-green-600 text-white p-1 rounded-full shadow-sm transition hover:scale-110" title="Tanya via WhatsApp">
...
<div id="modalPublicDetail" class="fixed inset-0 z-[100] hidden items-center justify-center">
    ...
    <div class="relative bg-white rounded-3xl shadow-2xl w-full max-w-2xl mx-4 overflow-hidden animate-modal">
        ...
        <div class="bg-gray-50 px-8 py-5 flex items-center justify-between border-t border-gray-100">
            ...
            <a id="wa_detail_btn" href="#" target="_blank" class="bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-2xl text-xs font-bold uppercase tracking-widest shadow-xl transition-all flex items-center gap-2">
...
<script>
    ...
    function openPublicDetail(obat) {
        ...
        // Update WA Button Link with dynamic medicine name
        const encodedNama = encodeURIComponent(obat.nama_obat);
        document.getElementById('wa_detail_btn').href = 'https://wa.me/6285385984906?text=Halo%20Apotek%20Haksa%20Farma%2C%20saya%20ingin%20tanya%20obat%3A%20' + encodedNama;
